...
export function TaskTest() {
    ...
    const [pageName, setPageName] = useState("Campanha/Teste de Exercício")
    ...
    //     setPageName("Campanha/Teste de Exercício")
    // })
    ...
    const [currentCommonTaskText1, setCurrentCommonTaskText1] = useState(
        "Alguém tentou usar o <code>console.log()</code>, mas esqueceu parte da sintaxe. Corrija o código para que ele funcione corretamente e exiba a mensagem no console."

    )//Mas o que isso significa na prática?
    const [currentCommonTaskText2, setCurrentCommonTaskText2] = useState(
        "Reescreva o código idêntico, exceto a parte onde está o erro."
    )
    const [currentCommonTaskType, setCurrentCommonTaskType] = useState("toCorrect")
    const [currentCommonTaskCode, setCurrentCommonTaskCode] = useState(`console.log 'Olá mundo!'`
    )
...

                            {
                                ...
                                (currentCommonTaskType == "explanation" || currentCommonTaskType == "advertising") ?
                                    (<div className="task_part_bottom">
                                        ...
                                        <button id="continue_button_1" onClick={() => {
                                            // nextTask(true)
                                        }}>Continuar</button>
                                    </div>)
                                    :
