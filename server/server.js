...
const groupTaskRoutes = require("./routes/groupTaskRoutes.js")
...
const groupLessonRoutes = require("./routes/groupLessonRoutes.js")
const commonLessonRoutes = require("./routes/commonLessonRoutes.js")
const notificationRoutes = require("./routes/notificationRoutes.js")
const userGroupTaskRoutes = require("./routes/userGroupTaskRoutes.js")
const userGroupLessonRoutes = require("./routes/userGroupLessonRoutes.js")
...
app.use('/api',userGroupLessonRoutes.router)
...
app.use('/api',groupTaskRoutes.router)
...
app.use('/api',groupLessonRoutes.router)
app.use('/api',solicitationRoutes.router)
app.use('/api',userGroupTaskRoutes.router)
